...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    brand: 'Inno64',
    name: 'Honda Civic Type-R (FD2) 碳纖特仕版',
    scale: '1:64',
    spec: '冠軍白 (碳纖引擎蓋)',
  ...
  },
  {
    id: 'prod-006-b',
    sku: 'MGT-00555-CHASE',
    normalizedSku: 'MGT00555CHASE',
    barcode: '4892442005551',
    brand: 'Mini GT',
    name: 'Nissan GT-R NISMO GT3 #23 2024 隱藏版生膠胎',
    scale: '1:64',
    spec: 'Chase 隱藏生膠胎特別版',
    imageUrl: '/images/products/prod-006.webp',
    listPrice: 980,
